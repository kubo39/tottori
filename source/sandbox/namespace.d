...
class ChrootJail
{
  ...
  this()
  {
    ...
    errnoEnforce(mount("tempfs".toStringz, dirname, "tempfs".toStringz,
        MS_NOATIME | MS_NODEV | MS_NOEXEC | MS_NOSUID, null) == 0);
  }
...
pid_t spawnJail(Profile profile, in char[][] args, in string[string] env = null)
{
  ...
  assert(core.sys.posix.unistd.read(fds[0], cast(void*)&grandchildPid,
